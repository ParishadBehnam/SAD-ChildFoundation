# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2018-01-31 13:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(null=True, upload_to='', verbose_name='تصویر')),
        ...
        migrations.CreateModel(
            name='add_madadjoo_admin_letter',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.TextField(default='')),
                ('date', models.DateTimeField(auto_now=True)),
                ('thank', models.BooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('mo', 'monthly'), ('ann', 'annual'), ('inst', 'instantly')], max_length=60, null=True)),
        ...
        migrations.CreateModel(
            name='admin_user',
            fields=[
                ('madadkar_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='active_user.madadkar')),
            ],
            options={
                'verbose_name': 'مدیر',
                'verbose_name_plural': 'مدیران',
            },
            bases=('active_user.madadkar',),
            managers=[
                ('objects', django.contrib.auth.models.UserManager()),
            ],
        ),
        migrations.AddField(
            model_name='warning_admin_letter',
            name='madadkar',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receiver', to='active_user.madadkar'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='substitute_a_madadjoo',
            name='substituted_madadjoo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='active_user.madadjoo'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='add_madadjoo_admin_letter',
            name='madadjoo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='active_user.madadjoo'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='warning_admin_letter',
            name='admin_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sender', to='active_user.admin_user'),
        ),
