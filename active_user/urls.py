...
urlpatterns = [
    ...
    url(r'^show_madadjoo_madadkar$', views.show_madadjoo_madadkar, name='show_madadjoo_madadkar'),
    ...
    url(r'^show_a_not_mine_madadjoo$', views.show_a_not_mine_madadjoo, name='show_a_not_mine_madadjoo'),
    ...
    url(r'^own_payment_reports_admin$', views.own_payment_reports_admin, name='own_payment_reports_admin'),
    ...
    url(r'^support_a_madadjoo_madadkar$', views.support_a_madadjoo_madadkar, name='support_a_madadjoo_madadkar'),
    url(r'^select_to_substitute_a_madadjoo_hamyar', views.select_to_substitute_a_madadjoo_hamyar, name='select_to_substitute_a_madadjoo_hamyar'),
    ...
    url(r'^delete_letter_adminr$', views.delete_letter_admin, name='delete_letter_admin'),
    ...
    url(r'^substitute_madadjoo_hamyar$', views.substitute_madadjoo, name='substitute_madadjoo_hamyar'),
    ...
    url(r'^change_madadkar_letters', views.change_madadkar_letters, name='change_madadkar_letters'),
    url(r'^madadjoo_letters_admin', views.madadjoo_letters_admin, name='madadjoo_letters_admin'),
    url(r'^confirm_need_admin', views.confirm_need_admin, name='confirm_need_admin'),
    url(r'^confirm_change_madadkar', views.confirm_change_madadkar, name='confirm_change_madadkar'),
